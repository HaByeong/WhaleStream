...
### 메인 페이지
![랜딩 페이지](./images/WhaleStream_Main_Final.png)

### 주요 기능
프론트엔드는 완전히 구현되었으며, 모든 페이지와 기능이 작동합니다. 백엔드 API가 준비되면 즉시 연동 가능합니다.

---

⚠️ 이 프로젝트는 현재 개발 중입니다. 프론트엔드는 완료되었으며, 백엔드 기능은 순차적으로 구현되고 있습니다.
